...
class DataTrainingArguments:
    ...
    source_prefix: Optional[str] = field(
        default=None, metadata={"help": "A prefix to add before every source text (useful for google/mt5 models)."}
    )
...
def main():
    ...
    if data_args.source_prefix is None and model_args.model_name_or_path in [
        ...
        logger.warning(
            "You're running a google/mt5 model but didn't provide a source prefix, which is the expected, e.g. with "
    ...
    if conditions_columns is not None:
        ...
        logger.info("Full conditions list: {all_conditions}")
    ...
    def preprocess_function(examples):
        ...
        if conditions_columns:
            ...
            try:
                ...
                print(inputs, conditions, prefix)
